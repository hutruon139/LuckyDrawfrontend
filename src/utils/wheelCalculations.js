// components/AdminPanel.jsx - PRODUCTION READY - No console logs
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
        <div className="flex justify-between items-center mb-6">
          ...
          >
            <button
              onClick={onGoHome}
              className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg relative z-50"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-blue-500/20 rounded-xl p-4 text-center border border-blue-500/30">
            ...
            <div className="text-blue-200 text-sm">1 Thử thách</div>
          ...
          <div className="bg-purple-500/20 rounded-xl p-4 text-center border border-purple-500/30">
            ...
            <div className="text-purple-200 text-sm">2 Thử thách</div>
          ...
          <div className="bg-red-500/20 rounded-xl p-4 text-center border border-red-500/30">
            ...
            <div className="text-red-200 text-sm">3 Thử thách</div>
