      ...
      >
        ...
        <div className="absolute top-8 left-1/2 transform -translate-x-1/2">
          <div className="flex items-center justify-center">
            <span className="text-red-600 font-bold text-3xl tracking-tight">TECHCOM</span>
            <span className="text-gray-800 font-bold text-3xl tracking-tight">BANK</span>
        ...
        <div className="text-center">
          ...
          <h2 className="text-red-600 text-5xl font-bold mb-8">
            PHIÊN BẢN VƯỢT TRỘI<br/>
            CỦA GIA ĐÌNH MÌNH
          </h2>
          
          {/* Touch instruction */}
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl px-8 py-6 shadow-xl border border-gray-200 max-w-md mx-auto">
            <div className="text-gray-800 font-medium text-lg mb-2">
              {familyName ? `Cảm ơn ${familyName}!` : 'Chào mừng đến với Ngày Hội Gia Đình!'}
            </div>
          ...
          <div className="bg-transparent px-10 py-6">
            <div className="text-center">
              <div className="text-gray-800 font-bold text-center text-2xl mb-2 drop-shadow-lg">
                Cảm ơn <span className="text-red-600 font-extrabold animate-pulse">{familyName}</span>!
              </div>
