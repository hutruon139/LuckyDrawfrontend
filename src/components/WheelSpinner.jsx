  ...
  const WheelSpinner = forwardRef(
    ({ isSpinning, prizeResult, onSpinComplete, onSpinStart }, ref) => {
      ...
      const startSpin = (targetResult) => {
        ...
        const targetSegment = segments.find((s) => s.group === targetResult.group);
        if (!targetSegment) {
          console.error("❌ No matching segment found for group:", targetResult.group);
          setIsInternalSpinning(false);
          return;
        }
            ...
            <div className="relative mx-auto w-96 h-96 mb-8">
              ...
              >
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  <div
                    className="absolute inset-0 border-r-2 border-white/50"
                    style={{ transform: "rotate(315deg)", transformOrigin: "center" }}
                  ></div>
                </div>
                ...
                <div className="text-white space-y-3">
                  ...
                  <div className="border-t border-white/20 pt-3">
                    <div className="flex items-center justify-center space-x-2 text-sm">
                      <span>🎁</span>
                      <span>
                        Nhóm: <span className="font-semibold">{prizeResult.label}</span>
                      </span>
                    </div>
                    <div className="flex items-center justify-center space-x-2 text-sm mt-2">
                      <span>⚡</span>
                      <span>
                        Thử thách: <span className="font-semibold">{prizeResult.challenges || 0}</span>
                      </span>
                    </div>
                  </div>
                </div>
